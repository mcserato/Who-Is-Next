...
CREATE TABLE CLASS 
	(class_id INT AUTO_INCREMENT, 
	 ...
	 CONSTRAINT WHOISNEXT_CLASS_FK FOREIGN KEY(emp_num) REFERENCES FACULTY(emp_num) ON DELETE CASCADE ON UPDATE CASCADE
	);
...
CREATE TABLE CLASS_STUDENT 
	(class_id INT NOT NULL REFERENCES CLASS(class_id) ON DELETE CASCADE ON UPDATE CASCADE,
	 student_number VARCHAR(10) NOT NULL REFERENCES STUDENT(student_number) ON DELETE CASCADE ON UPDATE CASCADE,
...
INSERT INTO STUDENT VALUES (201308197, "Adriell Dane", "Cabela", "de Guzman", "CAS", "BSCS", "M", "pic ni b2s", STR_TO_DATE('1997-01-29', '%Y-%m-%d'));
INSERT INTO STUDENT VALUES (201308210, "Jan Charles", "Maghirang", "Adono", "CAS", "BSCS", "M", "pic ni jeyseh", STR_TO_DATE('1997-02-01', '%Y-%m-%d'));
INSERT INTO STUDENT VALUES (201307115, "Gio Joshua", "IDK", "Peralta", "CAS", "BSCS", "M", "pic ni gio", STR_TO_DATE('1997-09-11', '%Y-%m-%d'));
INSERT INTO STUDENT VALUES (201300001, "Joseph Tuan", "Cosico", "Truong", "CA", "BSFT", "M", "pic ni tuan", STR_TO_DATE('1997-07-12', '%Y-%m-%d'));
INSERT INTO STUDENT VALUES (201300002, "Carmina", "Romulo", "Barbaza", "CEM", "BSAECO", "F", "pic ni mina", STR_TO_DATE('1997-01-01', '%Y-%m-%d'));
INSERT INTO STUDENT VALUES (201300003, "Alyssa", "Hernandez", "Albajera", "CEAT", "BSChE", "F", "pic ni alba", STR_TO_DATE('1997-01-02', '%Y-%m-%d'));
INSERT INTO STUDENT VALUES (201300004, "Adriel", "Umali", "Palomar", "CEAT", "BSCE", "M", "pic ni palomar", STR_TO_DATE('1997-04-15', '%Y-%m-%d'));
INSERT INTO STUDENT VALUES (201300005, "Paolo", "Courtney", "Roces", "CA", "BSFT", "M", "pic ni paolo", STR_TO_DATE('1997-04-28', '%Y-%m-%d'));
INSERT INTO STUDENT VALUES (201300006, "Marrick", "Malolos", "Mutya", "CEM", "BSAECO", "M", "pic ni marrick", STR_TO_DATE('1997-03-26', '%Y-%m-%d'));
INSERT INTO STUDENT VALUES (201300007, "Camille", "Hernandez", "Belda", "CAS", "BACA", "F", "pic ni camille", STR_TO_DATE('1997-01-03', '%Y-%m-%d'));
INSERT INTO STUDENT VALUES (201300008, "Alyanna Pauline", "IDK2", "Bascao", "CAS", "BSCS", "F", "pic ni pau", STR_TO_DATE('1995-12-24', '%Y-%m-%d'));
INSERT INTO STUDENT VALUES (201200003, "Nicole", "IDK3", "Martir", "CHE", "BSN", "F", "pic ni nicole", STR_TO_DATE('1996-01-02', '%Y-%m-%d'));
INSERT INTO STUDENT VALUES (201300032, "Arriane", "IDK4", "Jimena", "CFNR", "BSF", "F", "pic ni arraine", STR_TO_DATE('1997-01-08', '%Y-%m-%d'));
INSERT INTO STUDENT VALUES (201400009, "Lara", "IDK5", "Esguerra", "CDC", "BSDC", "F", "pic ni lara", STR_TO_DATE('1998-01-02', '%Y-%m-%d'));
INSERT INTO STUDENT VALUES (201300010, "Perico Dan", "IDK5", "Dionisio", "CAS", "BSCS", "M", "pic ni perico", STR_TO_DATE('1997-01-04', '%Y-%m-%d'));
INSERT INTO STUDENT VALUES (201300011, "Dana", "IDK6", "Magpusao", "CAS", "BSCS", "F", "pic ni dana", STR_TO_DATE('1997-01-02', '%Y-%m-%d'));
INSERT INTO STUDENT VALUES (201300012, "Aron", "IDK7", "Vibar", "CAS", "BSCS", "M", "pic ni ajay", STR_TO_DATE('1997-01-02', '%Y-%m-%d'));
INSERT INTO STUDENT VALUES (201300013, "Mon", "IDK8", "Frias", "CAS", "BSCS", "M", "pic ni Mon", STR_TO_DATE('1997-02-02', '%Y-%m-%d'));
INSERT INTO STUDENT VALUES (201300014, "Arthjoseph", "IDK9", "Sabino", "CAS", "BSCS", "M", "pic ni arth", STR_TO_DATE('1997-02-03', '%Y-%m-%d'));
INSERT INTO STUDENT VALUES (201300015, "Reynaldo", "ReyTZ", "Bayeta", "CAS", "BSCS", "M", "pic ni reytz", STR_TO_DATE('1997-02-04', '%Y-%m-%d'));
INSERT INTO STUDENT VALUES (201300016, "Aleli", "Sonza", "Legaspi", "CAS", "BSCS", "F", "pic ni aleli", STR_TO_DATE('1997-01-02', '%Y-%m-%d'));
INSERT INTO STUDENT VALUES (201300017, "Maru", "Sanchez", "Baul", "CAS", "BSCS", "M", "pic ni maru", STR_TO_DATE('1997-02-03', '%Y-%m-%d'));
INSERT INTO STUDENT VALUES (201300018, "Miles", "IDK10", "Basnilio", "CAS", "BSCS", "M", "pic ni miles", STR_TO_DATE('1997-02-04', '%Y-%m-%d'));
