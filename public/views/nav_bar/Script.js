                        ...
                        '<nav class="z-depth-0">',
                            ...
                            '</a>',
                              '<ul class="user-menu right">',
                                ...
                                '<li>',
                                    '<a href="#" id="settings" class="btn black btn-circle dropdown-button" style="margin-top:20px;" data-activates="user-settings">',
                                        '<i class="material-icons" id ="setting">settings</i>',
                                    '</a>',
                                '</li>',
                              '</ul>',
                        '</nav>',
